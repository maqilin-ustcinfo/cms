package com.tz.cms.activitimanage.service.impl;
...
import com.tz.cms.activitimanage.mapper.LeaveBeanMapper;
import com.tz.cms.activitimanage.service.ILeaveBeanService;
import com.tz.cms.activitimanage.service.IWorkFlowService;
...
public class  LeaveBeanService implements ILeaveBeanService{
	...
	public boolean addLeaveBean(LeaveBean leaveBean) {
		//加入录入的用户id
		//初始化状态的录入
		leaveBean.setLeaveUserId(Long.parseLong(UserUtils.getCurrrentUserId()+""));
	...
	public void doLeaveProcess(Long leaveId) {	 
		...
		ProcessInstance processInstance = 
					this.workFlowService.startProcess(leaveProcessKey,businessKey,variables);
		//将流程实例id与leaveId绑定,在查看任务处理图的时候,需要用到
