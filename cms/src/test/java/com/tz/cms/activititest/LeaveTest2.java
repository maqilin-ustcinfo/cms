...
public class LeaveTest2 {
    ...
    public void testStartProcess(){
        ...
        System.out.println("流程实例ID:"+processInstance.getProcessInstanceId());//80001
        System.out.println(processInstance.getProcessDefinitionId());

        //查询下级任务
        Task nextTask = getTaskbyBusinessKey(businessKey);
        System.out.println("下级审核任务ID:"+nextTask.getId());
        System.out.println("下级审核任务名称:"+nextTask.getName());
        System.out.println("下级审核人:"+nextTask.getAssignee());
    ...
    public void getPersonTask(){
        ...
        for(Task task : taskList){
            ...
            System.out.println("任务环节key:"+task.getTaskDefinitionKey());
            System.out.println("流程变量:"+task.getProcessVariables());
            System.out.println("工单标题:"+task.getProcessVariables().get("title"));
            ProcessInstance processInstance = processEngine.getRuntimeService().createProcessInstanceQuery().
                    processInstanceId(task.getProcessInstanceId()).singleResult();
            System.out.println("业务数据key:"+processInstance.getBusinessKey());
        }
    }
